...
fun firebaseUI(context: Context, courseList: SnapshotStateList<Employees?>) {
    Column(modifier = Modifier
        ...
        TopAppBar(
            ...
            navigationIcon = {
                IconButton(onClick = { context.startActivity(Intent(context,AddDetailsActivity::class.java))}) {
                ...
                Card(
                    ...
                    Column(modifier = Modifier
                        ...
                        Row {
                            ...
                            courseList[index]?.employeeName?.let {
                                Text(
                                    text = it,
                        ...
                        Row {
                            ...
                            courseList[index]?.employeeAge?.let {
                                Text(
                                    text = it,
                                    modifier = Modifier.padding(4.dp),
                                    color = Color.Black,
                        ...
                        Row {
                            ...
                            courseList[index]?.employeeSalary?.let {
                                Text(
                                    text = it,
                                    modifier = Modifier.padding(4.dp),
                                    color = Color.Black,
